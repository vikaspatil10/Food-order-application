...
export const sample_food_data:food[]=[

  {
    "id": "1",
    "name": "Spaghetti Carbonara",
    "price": "10.99",
    "tag": ["Italian", "Pasta", "Carbonara"],
    "favourite": true,
    "stars": 4.5,
